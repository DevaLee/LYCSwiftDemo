...
@objc protocol LYCWaterfallLayoutDataSource : class {
    func waterfallLayout(_ layout : LYCCollectionViewLayout, indexPath : IndexPath) -> CGFloat
    @objc optional func numberOfColsInWaterfallLayout(_ layout : LYCCollectionViewLayout) -> Int
}

class LYCCollectionViewLayout: UICollectionViewFlowLayout {
    
    // MARK: 对外提供属性
    weak var dataSource : LYCWaterfallLayoutDataSource?
...
extension LYCCollectionViewLayout {
